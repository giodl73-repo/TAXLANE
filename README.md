...
TRIBUNAL supplies the third Level 2 comparison baseline. Southern Texas now has
a replayable March 2026 district/case-type surface: 21,226 filings, 18,155
pending matters, 801 weighted filings per judgeship, 46.0 vacancy months, and
8,049 immigration felony defendants nested within 9,754 felony defendants.
...
SHIELD then resolves the current registry into 2,838 area and 4,844 facility
designations. The area side contains 762 multi-component and 155 multi-county
designations; 18 facility IDs retain invalid common-county keys as an explicit
residual. [The geography disposition](docs/reading/shield-hrsa-primary-care-geography-disposition.md)
...
SHIELD now adds observed 2024 Medicare inpatient origin-destination flow. Exact
same-year provider identity retains 13,330,468 classified cases, of which
11,586,529 (86.92%) cross a ZIP boundary. [The inpatient-flow disposition](docs/reading/shield-cms-inpatient-origin-destination-disposition.md)
admits that cross-ZIP context while refusing to call it a county crossing,
...
The enacted-law audit corrects one reporting boundary: §15-129 requires
borough—not community-district or division—disaggregation. [The reporting-scope
disposition](docs/reading/shield-nyc-ems-local-law-119-reporting-scope-disposition.md)
admits the official website, citywide/borough surface, and 147 monthly labels
from April 2014 through June 2026. Council/Mayor submission, discrete yearly
publication, full statutory compliance, performance, and fiscal claims remain
held, with no rate change.

SHIELD now joins Category 9 and dispatch context across 60 named-borough/month
observations. [The operations-context disposition](docs/reading/shield-nyc-ems-category9-operations-context-disposition.md)
admits reproducible ecological associations for hypothesis prioritization while
