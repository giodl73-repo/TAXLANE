...
| `breadth_benchmark_matrix/` | Typed breadth/depth inventory with current values, matched benchmarks, comparison grades, explicit coverage gaps, and separate improper-payment/fraud/savings fields. | Draft; peer gaps are comparisons, not fraud or savings estimates. |
