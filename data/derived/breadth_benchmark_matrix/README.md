...
`education_workforce_scenario_gate.v1.draft.json` freezes the FY2025 federal
education/workforce current-law context at $72.042B and blocks target-cost,
federal-effect, savings, solver, and balanced-rate use until federal/state/local
translation, package design, floors, behavior, incidence, distribution, and
policy-specific score provenance exist.
