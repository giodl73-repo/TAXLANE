...
| `performance-demand-response-bundle.applied-example.schema.md` | Field contract for the machine-readable bundle manifest. | Must document manifest fields and blocked-claim guardrails. |
