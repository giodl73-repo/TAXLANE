# Payment Integrity Methodology Component Gate Source Query Runs Schema

One JSON object per line.

| Field | Type | Meaning |
|---|---|---|
| `record_id` | string | Stable component gate source-query-run identifier. |
| `record_family` | string | Must be `payment_integrity_methodology_component_gate_source_query_run`. |
| `source_component_gate_source_query_record_id` | string | Source query to run. |
