# Payment Integrity Methodology Component Gate Requirements Schema

One JSON object per line.

| Field | Type | Meaning |
|---|---|---|
| `record_id` | string | Stable component gate-requirement identifier. |
| `record_family` | string | Must be `payment_integrity_methodology_component_gate_requirement`. |
| `source_component_progress_record_id` | string | Component-progress row that remains blocked. |
