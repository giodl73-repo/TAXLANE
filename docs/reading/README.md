...
114. Read `taxlane-showcase-readiness-summary.md` before describing Taxlane as
     showable. It is demo-ready as a source-custody and readiness guardrail
     system, but solver inputs, rates, savings, public rate cards, department
     cut instructions, technology-savings claims, and balanced-budget claims
     remain blocked.
115. Read `revenue-solvency-outcome-floor-definition-packet.md` before treating
...
141. Read `social-security-source-readiness-gap.md` before using CY2025 OASDI
     ...
     balanced-budget claims remain blocked.
135. Read `social-security-source-capture-queue.md` before capturing Social
...
136. Read `defense-source-readiness-gap.md` before treating defense source
     ...
     balanced-budget claims remain blocked.
137. Read `defense-source-capture-queue.md` before capturing defense solver or
     ...
     blocked.
138. Read `defense-source-capture-status-rollup.md` before treating defense
     ...
     technology-savings claims, and balanced-budget claims remain blocked.
139. Read `defense-source-capture-closure-work-queue.md` before treating
