...
| `health-target-cost-scenario.md` | Health readiness boundary that hardens the strongest private-insurance sensitivity without turning it into savings or a federal effect. |
