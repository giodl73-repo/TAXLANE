...
| `income-security-family-scenario-gate.md` | Income-security/family scenario-readiness gate: FY2025 function context, missing benefit-package/take-up/floor models, and blocked package/rate/savings claims. |
