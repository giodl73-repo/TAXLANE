...
- **Current law**: what the tax and budget system does now.
- **Allocation model**: a transparent educational model, not a legal tracing of
  dollars.
...
| `transportation-pilot-floor-indicator-contract.md` | Pulse 92 floor contract: defines transportation floor indicator families while setting no thresholds, recording no floor passes, and keeping simulator/rate/savings claims blocked. |
| `transportation-pilot-modernization-path-contract.md` | Pulse 93 modernization contract: defines transportation modernization row requirements while blocking productivity credit, technology-savings, simulator/rate/savings, and balanced-budget claims. |
| `transportation-pilot-stress-path-contract.md` | Pulse 94 stress contract: defines adverse-realization requirements for the same transportation policy while blocking aggressive-cut, simulator/rate/savings, and balanced-budget claims. |
| `transportation-pilot-fy2025-anchor-custody.md` | Pulse 95 custody record: verifies the already-local OMB FY2025 transportation anchor file, hash, and component reconciliation while keeping the full baseline and simulator/rate/savings claims blocked. |
| `transportation-pilot-partial-federal-outlay-path.md` | Pulse 96 partial path: adds already-local OMB PBD FY2025-FY2031 transportation federal net outlays while keeping FY2032-FY2035 null and full baseline/rate/savings claims blocked. |
| `transportation-pilot-trust-fund-source-custody.md` | Pulse 97 custody record: locks the already-local OMB funds appendix PDF for transportation trust-fund work while extracting no annual values and keeping reconciliation/rate/savings claims blocked. |
...
| `reserve-rule-contract.md` | Pulse 102 contract: defines required reserve accounting fields while keeping all reserve parameters null and solver/rate/savings claims blocked. |
| `reserve-parameter-readiness-gate.md` | Pulse 103 gate: names reserve parameter decisions still null and blocked before solver use. |
...
| `medicare-hi-omb-cms-receipt-row-perimeter-evidence.md` | Pulse 149 evidence boundary: recomputes Medicare HI CMS/OMB receipt context while keeping the perimeter bridge incomplete and all rate/solver claims blocked. |
...
| `medicare-hi-policy-behavior-reform-yield-closure-gap.md` | Pulse 154 gap: preserves Medicare HI policy-behavior reform-yield blockers while keeping reform yield, rates, and solver claims blocked. |
| `medicare-hi-rate-solver-readiness-review-closure-gap.md` | Pulse 155 gap: preserves Medicare HI final readiness-review blockers while keeping rate publication, solver inputs, and public claims blocked. |
...
| `outcome-floor-thresholds-gap.md` | Pulse 160 gap: preserves outcome-floor threshold/pass-fail blockers while keeping lower-cost scenarios, target costs, savings, solver inputs, and public claims blocked. |
...
| `lane-depth-explainability-tracker.md` | Pulse 110 tracker: answers whether lane depth and public explainability are complete while keeping every lane blocked for rates and public claims. |
...
2. Read `modeled-income-tax-outlays.md` for broad modeled allocation and
   financing context.
...
85. Read `wave5-fiscal-control-overlay-depth-packets.md` before treating
...
88. Read `current-law-source-custody-batch-plan.md` before future source
...
91. Read `current-law-baseline-annual-path-partial.md` when using forward-year
    ...
    evidence.
92. Read `current-law-baseline-receipts-deficit-path-partial.md` when using
...
103. Read `income-security-family-source-readiness-gap.md` before treating
     income-security/family source families as raw custody or model evidence.
     Benefit-package models, take-up models, floor values, federal/state/local
     translation, solver inputs, rates, savings, department-cut instructions,
     technology-savings claims, and balanced-budget claims remain blocked.
104. Read `income-security-family-source-capture-queue.md` before capturing
     income-security/family solver or floor sources. It orders federal program
     perimeter, CBO baseline/take-up, child poverty, childcare/family-service,
     food hardship/nutrition, and international comparator source work, but all
...
106. Read `income-security-family-source-capture-closure-work-queue.md` before
     ...
     nutrition, and comparator lineage work, but all closure values, lineage
     completion, solver inputs, rates, savings, department-cut instructions,
     technology-savings claims, and balanced-budget claims remain blocked.
107. Read `income-security-family-federal-program-perimeter-bridge.md` before
     using the FY2025 income-security/family federal account perimeter. It
...
108. Read `income-security-family-cbo-baseline-takeup-capture-gap.md` before
     ...
     and balanced-budget gates remain blocked.
109. Read `income-security-family-child-relative-poverty-context-bridge.md`
     before using the child relative-poverty context in income-security/family
     work. It is international OECD context only; Census domestic poverty
     custody, domestic income-unit context, floor values, pass/fail findings,
     solver inputs, rates, savings, and balanced-budget claims remain blocked.
110. Read `income-security-family-socx-family-benefit-comparator-bridge.md`
     before using SOCX family-benefit comparator context in
     income-security/family work. It is public family-benefit total/cash/service
     context only; tax-credit composition, childcare participation, ESSPROS/ILO,
     child-outcome linkage, solver inputs, rates, savings, and balanced-budget
     claims remain blocked.
111. Read `revenue-solvency-outcome-floor-definition-packet.md` before treating
...
112. Read `net-interest-outcome-floor-definition-packet.md` before treating any
...
113. Read `payment-integrity-outcome-floor-definition-packet.md` before treating
     ...
     findings, solver inputs, and balanced-budget claims remain blocked.
114. Read `veterans-outcome-floor-definition-packet.md` before treating any
     ...
     blocked.
115. Read `transportation-infrastructure-outcome-floor-definition-packet.md`
...
116. Read `education-workforce-outcome-floor-definition-packet.md` before
     ...
     remain blocked.
117. Read `disaster-resilience-outcome-floor-definition-packet.md` before
     ...
     savings, solver inputs, and balanced-budget claims remain blocked.
118. Read `justice-courts-public-safety-outcome-floor-definition-packet.md`
     ...
     costs, savings, solver inputs, and balanced-budget claims remain blocked.
119. Read `science-energy-environment-outcome-floor-definition-packet.md`
     ...
     remain blocked.
120. Read `agriculture-outcome-floor-definition-packet.md` before treating any
     ...
     thresholds, target costs, savings, solver inputs, and balanced-budget claims
     remain blocked.
121. Read `international-affairs-outcome-floor-definition-packet.md` before
     ...
     thresholds, target costs, savings, solver inputs, and balanced-budget claims
     remain blocked.
122. Read `lane-floor-readiness-rollup.md` to answer whether floor-definition
...
123. Read `lane-floor-source-work-queue.md` before capturing floor thresholds
...
124. Read `health-floor-source-capture-status.md` before treating existing OMB
     ...
     blocked.
125. Read `health-medicare-trustees-source-capture-status.md` before using CMS
     ...
     and balanced-budget claims remain blocked.
126. Read `health-nhe-source-custody-gap.md` before treating CMS NHE references
     ...
     claims remain blocked.
127. Read `health-cbo-source-custody-gap.md` before treating CBO references in
...
128. Read `health-quality-access-indicator-source-gap.md` before treating
     ...
     solver inputs, rates, savings, and balanced-budget claims remain blocked.
129. Read `health-source-readiness-rollup.md` to understand the current
     ...
     balanced-budget claims remain blocked.
130. Read `social-security-source-readiness-gap.md` before using CY2025 OASDI
     ...
     balanced-budget claims remain blocked.
131. Read `social-security-source-capture-queue.md` before capturing Social
...
132. Read `defense-source-readiness-gap.md` before treating defense source
     ...
     balanced-budget claims remain blocked.
133. Read `defense-source-capture-queue.md` before capturing defense solver or
     ...
     blocked.
134. Read `defense-source-capture-status-rollup.md` before treating defense
     ...
     technology-savings claims, and balanced-budget claims remain blocked.
135. Read `defense-source-capture-closure-work-queue.md` before treating
...
Allocation packets are educational models. Public wording should say "modeled
