...
110. Read `revenue-solvency-outcome-floor-definition-packet.md` before treating
...
111. Read `net-interest-outcome-floor-definition-packet.md` before treating any
...
112. Read `payment-integrity-outcome-floor-definition-packet.md` before treating
     ...
     findings, solver inputs, and balanced-budget claims remain blocked.
113. Read `veterans-outcome-floor-definition-packet.md` before treating any
     ...
     blocked.
114. Read `transportation-infrastructure-outcome-floor-definition-packet.md`
...
115. Read `education-workforce-outcome-floor-definition-packet.md` before
     ...
     remain blocked.
116. Read `disaster-resilience-outcome-floor-definition-packet.md` before
     ...
     savings, solver inputs, and balanced-budget claims remain blocked.
117. Read `justice-courts-public-safety-outcome-floor-definition-packet.md`
     ...
     costs, savings, solver inputs, and balanced-budget claims remain blocked.
118. Read `science-energy-environment-outcome-floor-definition-packet.md`
     ...
     remain blocked.
119. Read `agriculture-outcome-floor-definition-packet.md` before treating any
     ...
     thresholds, target costs, savings, solver inputs, and balanced-budget claims
     remain blocked.
120. Read `international-affairs-outcome-floor-definition-packet.md` before
     ...
     thresholds, target costs, savings, solver inputs, and balanced-budget claims
     remain blocked.
121. Read `lane-floor-readiness-rollup.md` to answer whether floor-definition
...
122. Read `lane-floor-source-work-queue.md` before capturing floor thresholds
...
123. Read `health-floor-source-capture-status.md` before treating existing OMB
     ...
     blocked.
124. Read `health-medicare-trustees-source-capture-status.md` before using CMS
     ...
     and balanced-budget claims remain blocked.
125. Read `health-nhe-source-custody-gap.md` before treating CMS NHE references
     ...
     claims remain blocked.
126. Read `health-cbo-source-custody-gap.md` before treating CBO references in
...
127. Read `health-quality-access-indicator-source-gap.md` before treating
     ...
     solver inputs, rates, savings, and balanced-budget claims remain blocked.
128. Read `health-source-readiness-rollup.md` to understand the current
     ...
     balanced-budget claims remain blocked.
129. Read `social-security-source-readiness-gap.md` before using CY2025 OASDI
     ...
     balanced-budget claims remain blocked.
130. Read `social-security-source-capture-queue.md` before capturing Social
...
131. Read `defense-source-readiness-gap.md` before treating defense source
     ...
     balanced-budget claims remain blocked.
132. Read `defense-source-capture-queue.md` before capturing defense solver or
     ...
     blocked.
133. Read `defense-source-capture-status-rollup.md` before treating defense
     ...
     technology-savings claims, and balanced-budget claims remain blocked.
134. Read `defense-source-capture-closure-work-queue.md` before treating
