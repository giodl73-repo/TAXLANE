...
| `health-policy-scored-reform-path.md` | Gate for health central/stress federal reform scoring; cash-flow fields stay null and solver-ineligible until a specific scored policy and outcome floors exist. |
