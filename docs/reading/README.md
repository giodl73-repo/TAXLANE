...
| `integrated-fiscal-solver.md` | Deterministic solver scaffold: FY2025 17-row reconciliation, separate funding-share denominators, endogenous-interest regression fixture, and blocked rates/reserves/distribution. |
