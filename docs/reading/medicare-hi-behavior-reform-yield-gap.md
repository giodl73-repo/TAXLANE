# Medicare HI behavior and reform-yield gap

This packet reads
`data/derived/breadth_benchmark_matrix/medicare_hi_behavior_reform_yield_gap.v1.draft.json`.

Pulse 146 records the behavior and reform-yield blocker for Medicare HI assigned-base work.
...
The current-law context remains diagnostic only:

- CMS payroll taxes: 400,622.16 million dollars.
- OMB Hospital Insurance receipt anchor: 395,350 million dollars.
- CMS minus OMB diagnostic difference: 5,272.16 million dollars.
- CMS total HI revenue: 458,772.597 million dollars.
- Diagnostic ratio: 3.0175 percent.
