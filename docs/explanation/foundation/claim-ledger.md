...
| CLM-14 | illustrative calculation | With unchanged TY2026 thresholds and a uniform +11-point change to all seven ordinary rates, the narrow bracket-only difference equals 11% of the specified taxable ordinary income. | scorer-ready specification; taxpayer-profile scenarios | “A transparent ordinary-bracket illustration.” | “Your tax bill rises by 11%,” a gross-income claim, or a complete household estimate. |
| CLM-15 | comparative interpretation | The captured 2022 comparison supports studying lower U.S. defense and health-cost shares, while the U.S. social-protection share is below the five displayed peers; none is an admitted savings or rate result. | OECD COFOG panel; site share calculation; taxpayer-profile scenarios | “Peer comparison identifies directional research cases.” | “Peer alignment proves these cuts,” “social services are too high,” or any synthetic lower rate. |
| CLM-16 | operational metadata | Repository inventory counts document corpus scale and validation coverage under a dated counting method. | repository corpus inventory snapshot | “The work has a large, traceable corpus.” | Using file counts as proof of correctness, policy impact, official acceptance, or endorsement. |
