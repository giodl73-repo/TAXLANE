...
| 02 | IRS rates first-source capture | pending | Capture IRS SOI Table 23 source metadata and prepare the first rates extraction path. |
| 03 | OMB receipts first-source capture | pending | Capture OMB receipt/fund spreadsheet metadata and prepare receipt/fund draft extraction. |
