# Pulse 187: Defense source capture queue

## Goal

Convert the defense source-readiness gap into ordered official-source capture
work without treating references as raw custody, force-structure plans,
procurement schedules, readiness floor values, solver inputs, rates, or savings.

## Implemented

- Added `defense_source_capture_queue.v1.draft.json`.
